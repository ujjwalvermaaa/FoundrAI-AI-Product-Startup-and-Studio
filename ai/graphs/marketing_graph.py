"""
ai.graphs.marketing_graph — LangGraph StateGraph pipeline for marketing strategy.
...
Usage:
    from ai.graphs.marketing_graph import build_marketing_graph, run_marketing_graph
    ...
    result = run_marketing_graph(state)
"""
...
def build_marketing_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for marketing strategy.
...
def run_marketing_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the marketing strategy graph synchronously.
