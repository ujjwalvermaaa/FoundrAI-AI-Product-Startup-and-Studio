"""
ai.graphs.validation_graph — LangGraph StateGraph pipeline for idea validation.
...
Usage:
    from ai.graphs.validation_graph import build_validation_graph, run_validation_graph
    ...
    state = make_initial_state(
        ...
        inputs={"idea_brief": "...", "project_name": "...", "industry": "..."},
    )
    result = run_validation_graph(state)
"""
...
def build_validation_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for idea validation.
...
def run_validation_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the validation graph synchronously.
