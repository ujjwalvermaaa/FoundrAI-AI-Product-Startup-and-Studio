"""
ai.graphs.architecture_graph — LangGraph StateGraph pipeline for technical architecture.
...
Usage:
    from ai.graphs.architecture_graph import build_architecture_graph, run_architecture_graph
    ...
    result = run_architecture_graph(state)
"""
...
def build_architecture_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for technical architecture.
...
def run_architecture_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the technical architecture graph synchronously.
