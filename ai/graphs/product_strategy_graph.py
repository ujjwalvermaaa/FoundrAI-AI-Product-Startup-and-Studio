"""
ai.graphs.product_strategy_graph — LangGraph StateGraph pipeline for product strategy.
...
Usage:
    from ai.graphs.product_strategy_graph import build_product_strategy_graph, run_product_strategy_graph
    ...
    result = run_product_strategy_graph(state)
"""
...
def build_product_strategy_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for product strategy.
...
def run_product_strategy_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the product strategy graph synchronously.
