"""
ai.graphs.business_model_graph — LangGraph StateGraph pipeline for business model generation.
...
Usage:
    from ai.graphs.business_model_graph import build_business_model_graph, run_business_model_graph
    ...
    result = run_business_model_graph(state)
"""
...
def build_business_model_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for business model generation.
...
def run_business_model_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the business model graph synchronously.
