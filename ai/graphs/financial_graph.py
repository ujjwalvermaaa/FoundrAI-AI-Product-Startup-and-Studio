"""
ai.graphs.financial_graph — LangGraph StateGraph pipeline for financial planning.
...
Usage:
    from ai.graphs.financial_graph import build_financial_graph, run_financial_graph
    ...
    result = run_financial_graph(state)
"""
...
def build_financial_graph() -> StateGraph:
    """
    Build the LangGraph StateGraph for financial planning.
...
def run_financial_graph(state: WorkflowState) -> WorkflowState:
    """
    Compile and run the financial planning graph synchronously.
