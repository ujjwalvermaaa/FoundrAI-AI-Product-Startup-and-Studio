...
function DocsPage() {
  return (
    <div className="max-w-6xl mx-auto p-6 md:p-8 space-y-8">
      <div>
        <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground font-medium">Documentation</div>
        <h1 className="font-display text-3xl md:text-4xl font-semibold tracking-tight mt-1">Everything you need to build.</h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {SECTIONS.map((s) => (
          <Card key={s.title} className="hover:border-primary/40 transition-colors group">
            <CardContent className="p-5 space-y-3">
              <div className="size-10 rounded-lg gradient-brand grid place-items-center shadow-glow"><s.icon className="size-5 text-white" /></div>
              <div>
