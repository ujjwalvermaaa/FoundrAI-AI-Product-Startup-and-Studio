...
import { Rocket, Building2, Users, Target, PartyPopper } from "lucide-react";
      ...
      <div className="relative z-10 min-h-screen grid place-items-center p-6">
        <div className="w-full max-w-lg">
          ...
          >
            ...
            <span className="font-display font-semibold text-lg tracking-tight">FoundrAI</span>
          </motion.div>

          <div className="mb-3 flex items-center justify-between text-[10px] uppercase tracking-[0.22em] text-primary/90 font-medium">
          ...
          >
            <Card className="hologram-edge shadow-glow overflow-hidden relative">
              <div className="scan-line absolute inset-0 opacity-15 pointer-events-none" />
              <CardContent className="relative p-8 min-h-[380px] flex flex-col">
                <AnimatePresence mode="wait">
                  ...
                  >
                    {step === 0 && (
                      <>
                        <div className="size-12 rounded-2xl gradient-brand grid place-items-center shadow-glow mb-4">
                          <Rocket className="size-5 text-white" />
                        </div>
                        <h1 className="font-display text-3xl font-semibold tracking-tight">Welcome to FoundrAI.</h1>
                        <p className="text-muted-foreground mt-2 leading-relaxed">
                          Let's set up your studio in under 60 seconds. We'll personalise Foundr around your goals.
                        </p>
                      </>
                    )}
                    {step === 1 && (
                        ...
                        <div className="mt-6 space-y-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <Input
                              ...
                              placeholder="Solo founder / CTO / PM"
                              className="rounded-xl"
                            />
                          </div>
                        </div>
                    ...
                    {step === 3 && (
                      <>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Pick up to 3. Foundr will bias recommendations toward these.
                        </p>
                          ...
                          {["Validation", "Positioning", "Roadmap", "Architecture", "Financials", "Fundraising", "Marketing", "Hiring"].map((f) => {
                            ...
                            return (
                              <button
                                ...
                                type="button"
                                onClick={() =>
                                  setFocus(on ? focus.filter((x) => x !== f) : focus.length < 3 ? [...focus, f] : focus)
                                }
                    ...
                    {step === 4 && (
                      <>
                        <motion.div
                          ...
                          className="size-16 rounded-2xl gradient-brand grid place-items-center shadow-glow mb-4"
                        >
                        ...
                        <p className="text-muted-foreground mt-2 leading-relaxed">
                          Your studio is personalised. Let's meet Foundr and start your first project.
                        </p>
                      </>
                    )}
                  </motion.div>
                ...
                <div className="mt-6 flex items-center gap-2">
                  ...
                  {step < total - 1 && (
                    <Button className="ml-auto rounded-xl shadow-glow" onClick={next}>
                      Continue
                    </Button>
                  )}
                  {step === total - 1 && (
                    <>
                      ...
                      <Button className="rounded-xl shadow-glow" onClick={() => navigate({ to: "/chat" })}>
                        Meet Foundr
                      </Button>
                    </>
                  )}
