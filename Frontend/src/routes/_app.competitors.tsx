...
function CompetitorsPage() {
  return (
    <AppPage className="max-w-6xl">
      ...
      >
        <div>
          <div className="text-xs uppercase tracking-[0.18em] text-primary/90 font-medium">Intelligence</div>
          <h1 className="font-display text-3xl md:text-4xl font-semibold tracking-tight mt-1 flex items-center gap-3">
            <Target className="size-8 text-primary" /> <span className="gradient-text">Competitors</span>
          </h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {COMPETITORS.map((c, i) => (
          ...
          >
            <Card className="hover:border-primary/40 transition-colors rounded-xl h-full">
              <CardHeader>
