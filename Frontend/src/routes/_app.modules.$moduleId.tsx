      ...
      <div className="grid lg:grid-cols-[1fr_320px] gap-6">
        <div>
          ...
          >
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-primary/90 font-medium">Module</div>
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-2 text-xs">
                {["v3 · 2m ago · AI", "v2 · yesterday · You", "v1 · 3 days ago · AI"].map((v) => (
                  <div key={v} className="flex items-center justify-between hover:bg-accent/40 rounded-xl px-2 py-1 cursor-pointer">
                    <span>{v}</span>
